  ...
  return (
    <footer className="py-8 bg-gray-900 border-t border-gray-700 text-center text-gray-400 text-sm">
      ...
      <div className="flex justify-center gap-4 mb-2">
        <a href="/timvis/privacy" className="hover:underline hover:text-gray-300">Privacy Policy</a>
        <a href="/timvis/terms" className="hover:underline hover:text-gray-300">Terms &amp; Conditions</a>
        <a href="/timvis/delete-account" className="hover:underline hover:text-gray-300">Delete Account</a>
      </div>
    </footer>
  );
}
